(()=>{
  ...
  const ICON='./icons/kagenexus-icon.png';
  const replacements=[
  ...
  function replaceLegacyMark(){
    ...
    if(!legacy||legacy.dataset.kageNexusLogo)return;
    legacy.dataset.kageNexusLogo='1';
    legacy.textContent='';
  ...
  function applyBrand(){
    ...
    replaceLegacyMark();
    document.documentElement.dataset.kageNexus='17';
  }
