const CACHE = 'kagenexus-v29-full-power-paths';
const CORE = [
  './',
  './index.html',
  './offline.html',
  './bootstrap-v4.js?release=27',
  ...
  './assets/css/power-transform-v29.css?release=29',
  './assets/js/power-transform-v29.js?release=29',
