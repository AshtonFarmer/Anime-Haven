const CACHE = 'kagenexus-v31-card-matcher';
const CORE = [
  './',
  './index.html',
  './offline.html',
  './bootstrap-v4.js?release=31',
  ...
  './assets/css/power-transform-v29.css?release=31',
  './assets/js/power-transform-v29.js?release=31',
