const CACHE = 'kagenexus-v30-live-transformations';
const CORE = [
  './',
  './index.html',
  './offline.html',
  './bootstrap-v4.js?release=30',
  ...
  './assets/css/power-transform-v29.css?release=30',
  './assets/js/power-transform-v29.js?release=30',
