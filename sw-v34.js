const CACHE = 'kagenexus-v43-arsenal-batch-5';
const CORE = [
  './',
  './index.html',
  './offline.html',
  './bootstrap-v4.js?release=43',
  ...
  './mobile-suite-loader-v22.js?release=43',
  './arsenal-v34.js?release=43',
  './arsenal-v34.css?release=43',
