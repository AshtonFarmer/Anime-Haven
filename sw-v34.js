const CACHE = 'kagenexus-v42-arsenal-batch-4';
const CORE = [
  './',
  './index.html',
  './offline.html',
  './bootstrap-v4.js?release=42',
  ...
  './mobile-suite-loader-v22.js?release=42',
  './arsenal-v34.js?release=42',
  './arsenal-v34.css?release=42',
