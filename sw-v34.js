const CACHE = 'kagenexus-v36-weapons-batch-two';
const CORE = [
  './',
  './index.html',
  './offline.html',
  './bootstrap-v4.js?release=36',
  ...
  './mobile-suite-loader-v22.js?release=36',
  './arsenal-v34.js?release=36',
  './arsenal-v34.css?release=36',
