const CACHE = 'kagenexus-v37-weapons-batch-three';
const CORE = [
  './',
  './index.html',
  './offline.html',
  './bootstrap-v4.js?release=37',
  ...
  './mobile-suite-loader-v22.js?release=37',
  './arsenal-v34.js?release=37',
  './arsenal-v34.css?release=37',
