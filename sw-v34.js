const CACHE = 'kagenexus-v41-arsenal-batch-3';
const CORE = [
  './',
  './index.html',
  './offline.html',
  './bootstrap-v4.js?release=41',
  ...
  './mobile-suite-loader-v22.js?release=41',
  './arsenal-v34.js?release=41',
  './arsenal-v34.css?release=41',
