const CACHE = 'kagenexus-v44-arsenal-batch-6';
const CORE = [
  './',
  './index.html',
  './offline.html',
  './bootstrap-v4.js?release=44',
  ...
  './mobile-suite-loader-v22.js?release=44',
  './arsenal-v34.js?release=44',
  './arsenal-v34.css?release=44',
