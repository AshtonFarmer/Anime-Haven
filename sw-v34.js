const CACHE = 'kagenexus-v40-arsenal-batch-2';
const CORE = [
  './',
  './index.html',
  './offline.html',
  './bootstrap-v4.js?release=40',
  ...
  './mobile-suite-loader-v22.js?release=40',
  './arsenal-v34.js?release=40',
  './arsenal-v34.css?release=40',
