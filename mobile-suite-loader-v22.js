(()=>{
  ...
  const registerCleanWorker=async()=>{
    ...
    try{
      const registration=await navigator.serviceWorker.register('./sw-v35.js?release=56',{scope:'./',updateViaCache:'none'});
  ...
  (async()=>{
    try{
      ...
      source=source
        .split('./sw-v2.js?release=22').join('./sw-v35.js?release=56')
        .split('./sw-v25.js?release=25').join('./sw-v35.js?release=56')
        .split('./sw-v25.js?release=25.1').join('./sw-v35.js?release=56')
        .split('./sw-v26.js?release=26').join('./sw-v35.js?release=56');
      document.getElementById('knContinueWatching')?.remove();
